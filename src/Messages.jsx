...
export default function Messages({onNavigate}) {
  ...
  return <>
    <button ref={trigger} className="dock-item messages-launcher" aria-label="Messages — Ask about Yogesh" onClick={open}><img src="/icons/messages.png" alt="" draggable="false"/><span className="tooltip">Messages</span></button>
